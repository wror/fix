...
public class UpstreamHandler<F extends FixFields> {
	...
	protected final OrderListener<F, OrderComposite<F>> publisher;
	...
	protected OrderComposite<F> getOrder(CharSequence orderID, CharSequence clOrdID, Consumer<CxlRejReason> rejector) {
		if (isDupe(clOrdID)) {
