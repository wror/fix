...
public class PassthroughFactory<F extends FixFields> {
	...
	@Inject
	public PassthroughFactory(IdGenerator idgen, SimpleOrderRepo exchangeOrderRepo, SimplePool listenerPool, OrderListener exchangeOrderPublisher) {
		this.idgen = idgen;
	...
	public void slicePassthrough(Order clientOrder, Parental parental) {
		slicePassthrough(clientOrder, parental, (F)new FixFields() { //TODO is this going to fly?
			@Override public long getOrderQty(){ return parental.getAvailableQty(); }
		});
	}

	public void slicePassthrough(Order clientOrder, Parental parental, F sliceFields) {
